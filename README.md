...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://artem-stackbit.ngrok.io/pull/6059fb0f97373dc4c2fc9694
...
To start editing your site, you can use the Sanity interface at https://marvelous-yam-9fb0f.sanity.studio/.
...
Generated at `2021-03-23T14:28:50.166Z` by Stackbit version `0.3.50-staging.0`.